...
let WalletAddressService = class WalletAddressService {
    ...
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const walletAddress = yield this.walletAddressRepository.findOne({ where: { id }, relations: ['user'] });
            if (!walletAddress) {
                throw new common_1.NotFoundException(`WalletAddress with ID ${id} not found`);
            }
    ...
    update(id, updateWalletAddressDto) {
        return __awaiter(this, void 0, void 0, function* () {
            const walletAddress = yield this.walletAddressRepository.preload(Object.assign({ id: +id }, updateWalletAddressDto));
            if (!walletAddress) {
                throw new common_1.NotFoundException(`WalletAddress with ID ${id} not found`);
            }
            return this.walletAddressRepository.save(walletAddress);
    ...
    remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const walletAddress = yield this.findOne(id);
            yield this.walletAddressRepository.remove(walletAddress);
        });
    }
};
